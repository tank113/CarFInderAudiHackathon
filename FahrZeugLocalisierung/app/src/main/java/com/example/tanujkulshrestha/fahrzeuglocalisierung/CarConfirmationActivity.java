...
public class CarConfirmationActivity extends AppCompatActivity {
    ...
    public void onLikeButtonClick(){
        RetrieveParkingSpotDetails retrieveParkingSpotDetails = new RetrieveParkingSpotDetails();
        retrieveParkingSpotDetails.new  CreateNewProduct(getApplicationContext()).execute(car_id);
