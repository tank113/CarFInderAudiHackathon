...
public class RetrieveParkingData extends AppCompatActivity {
    ...
    public class CreateNewProduct extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            String url_create_product = "http://10.180.87.63:8888/retrieve_parking.php?parking_slot_id="+parkIDToBeSearch;
        ...
        public void onPostExecute(String finalString) {
            ...
            String zone_image = (String) ((JSONObject) obj).get("zone_image");
            Intent intent = new Intent(context, DisplayParkingDetails.class);
            ...
            intent.putExtra("parking_id", parkIDToBeSearch);
